...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( /* Base */
    ...
    KC_EQL,  KC_PSLS,  KC_PAST,  KC_TAB,   KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,
    ...
    KC_P0,    SEND_00,  KC_PDOT,  KC_COMM,  KC_LCTL,  KC_LGUI,  KC_LALT,  KC_EQL,  KC_SPC,   KC_SPC,
    ...
    KC_SPC,   KC_EQL,  KC_EQL,  KC_RALT,  KC_APP,   KC_RCTL,  MO(1),    KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_EQL,
