...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( /* Base */
    KC_Q,  KC_Q,  KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,
    ...
    KC_P1,    KC_P6,    KC_LCTL,  KC_LGUI,  KC_LALT,  KC_Q,  KC_SPC,   KC_SPC,
    ...
    KC_SPC,   KC_Q,  KC_Q,  KC_RALT,  KC_APP,   KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_Q,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_Q,
